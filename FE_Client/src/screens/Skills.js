...
const Skills = () => {
    ...
    return (_jsxs("div", { className: "w-full h-[200px] overflow-hidden relative", style: containerStyle, children: [_jsx("div", { className: "flex", style: scrollAnimation, children: skillsData.concat(skillsData).map((skill, index) => (_jsxs("div", { className: "flex-shrink-0 w-[180px] h-[180px] mx-2 p-5 flex flex-col gap-5 justify-center items-center", children: [_jsx("img", { src: skill.Icon, alt: `${skill.name} logo`, className: "w-12 h-12" }), _jsx("p", { className: "text-lg", style: { color: `${color.textColor}` }, children: skill.name })] }, index))) }), _jsx("style", { children: `
        @keyframes scroll {
          0% {
